<div class="modal fade" id="lang_edit_modal">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
               <div class="row">
                   <div class="col">
                       <form action="" method="post" id="lang_edit_form">@csrf
                           <div class="form-row">
                               <div class="form-group col-md">
                                   <label><small>Select Language</small></label>
                                   <select name="language_id" id="lang_language_id">
                           ...
                           <div class="form-row">
                               <div class="form-group col-md">
                                   ...
                                   <select name="language_level_id" id="lang_language_level_id">
                                       <option value="">Select</option>
