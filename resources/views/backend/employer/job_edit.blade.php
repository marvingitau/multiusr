...
@section('content')
    <form action="{{route('employer.job.update',$job->id)}}" method="post">@csrf
        <div class="card ">
            ...
            <div class="card-body">
                ...
                <div class="form-row">
                    <div class="form-group col-md" data-toggle="tooltip" data-placement="top" title="Responsibility" >
                        ...
                        <textarea class="form-control"  rows="10"  id="responsibility" name="responsibility">{{$job->responsibility}}</textarea>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md" data-toggle="tooltip" data-placement="top" title="Education Requirement" >
                        ...
                        <textarea class="form-control"  rows="10"  id="edu_requirement" name="edu_requirement">{{$job->edu_requirement }}</textarea>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md" data-toggle="tooltip" data-placement="top" title="Additional Requirement" >
                        ...
                        <textarea class="form-control"  rows="10"  id="additional_requirement" name="additional_requirement">{{$job->additional_requirement}}</textarea>
                    </div>
                </div>
