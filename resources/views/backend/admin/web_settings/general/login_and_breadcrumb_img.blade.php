                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="img-responsive">
                                        ...
                                        <img src="{{asset('assets/frontend/img/general/general_section/login_bg_image.jpg')}}" style="width: 200px">
                                    </div>
                                ...
                                <div class="form-group col-md-6">
                                    <label for="sub_title">Breadcrumb Image <small>(jpg)</small></label>
                                    <div class="img-responsive">
                                        <img src="{{asset('assets/frontend/img/general/general_section/breadcrumb_image.jpg')}}" style="width: 300px">
                                    </div>
