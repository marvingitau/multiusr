...
@section('content')
    <div class="card ">
        <div class="card-body border-bottom">
            <h3>View Resume</h3>
            <form   method="get" action = "{{ url('admin/download/'.$user->id) }} ">
                <h2>Download</h2>
                <div class="form-group">
                     <label for="cv">CV
                    <input type="checkbox" class="form-control" name="cvChoice" id="cv" value="cv"></label>
                </div>

                 <div class="form-group">
                     <label for="coverletter">CoverLetter
                    <input type="checkbox" class="form-control" name="clChoice" id="coverletter" value="coverletter"></label>
                </div>
               
                
                <button type="submit" >Download CV and Cover</button>
            </form>
        </div>
